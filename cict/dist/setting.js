...
<body>
    ...
    <script>
        // \u521D\u59CB\u5316\u8BBE\u7F6E\u6570\u636E
        const settingsData = ${JSON.stringify(u)};
  ...
  `}function G(o){let u=o.records.map(e=>{let a=e.isOffice?"\u2705":"\u274C",i=e.period==="AM"?'<span class="badge badge-morning">\u4E0A\u5348</span>':'<span class="badge badge-afternoon">\u4E0B\u5348</span>';return`
    ...
    <div class="records-section">
      ...
      <div class="records-list">
        ${u||'<div class="no-records">\u6682\u65E0\u7B7E\u5230\u8BB0\u5F55</div>'}
      </div>
    </div>
  `}function B(o){return`
  ...
  `}function X(){let o={"Access-Control-Allow-Origin":"*","Access-Control-Allow-Methods":"POST,GET,OPTIONS,PUT,DELETE","Access-Control-Allow-Headers":"Origin, X-Requested-With, Content-Type, Accept"};if(r.isOptions)r.isQuanX()?r.done({headers:o}):r.done({response:{headers:o}});else if(r.isGet){let u=Object.assign(o,{"Content-Type":"text/html;charset=UTF-8"});r.isQuanX()?r.done({status:"HTTP/1.1 200",headers:u,body:r.html}):r.done({response:{status:200,headers:u,body:r.html}})}else if(r.isPost){let u=Object.assign(o,{"Content-Type":"application/json; charset=utf-8"}),f=r.toStr(r.json);r.isQuanX()?r.done({status:"HTTP/1.1 200",headers:u,body:f}):r.done({response:{status:200,headers:u,body:f}})}else r.done()}
